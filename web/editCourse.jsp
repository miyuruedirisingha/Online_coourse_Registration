...
<head>
    ...
    <title>Edit Course | NextGen</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="form-container p-5">
                    <h2 class="text-center mb-4"><i class="bi bi-pencil-square"></i> Edit Course</h2>
                    <%
                    ...
                    <form action="editCourseProcess.jsp" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="courseName" name="courseName" value="<%= course.getCourseName() %>" required>
                        </div>
                        <div class="mb-3">
                            <label for="lectureName" class="form-label">Lecture Name</label>
                            <input type="text" class="form-control" id="lectureName" name="lectureName" value="<%= course.getLectureName() %>" required>
                        </div>
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-check-circle"></i> Update Course</button>
                        </div>
                    </form>
                </div>
            </div>
